...
function Illustration() {
  return (
    <svg aria-hidden="true" className="gd-illustration-icon" fill="none" viewBox="0 0 96 96">
      <path d="M24 24h34c8 0 14 6 14 14v34H38c-8 0-14-6-14-14V24Z" />
      <path d="M72 24H38c-8 0-14 6-14 14" />
      <path d="M38 38h20" />
      <path d="M38 50h20" />
    </svg>
  )
...
const page: GuidePage = {
  slug: "be-a-ba-do-consorcio",
  title: "O bê-á-bá do Consórcio",
  eyebrow: "Educação",
  description: "Faça acontecer com a Multiplic Consórcios.",
  sections: [
    {
      title: "01. Fui contemplado e agora?",
      paragraphs: [
        "Quando você for contemplado vai precisar passar pelo processo de aprovação de cadastro para ter o crédito liberado. Aí, é só realizar a compra do seu bem tão sonhado. A carta de crédito corresponde a dinheiro à vista e, dessa forma, você tem maior poder de negociação para fazer o melhor negócio na hora da compra.",
        "E depois de ser contemplado? Após pegar o dinheiro para comprar o seu imóvel, ele ficará alienado e você continua pagando as parcelas do consórcio normalmente, até o encerramento do seu plano.",
        "E se demorar para ser contemplado? Em algum momento isso deve acontecer. As contemplações são realizadas por sorteio e por lance. Assim, você poderá ter o seu crédito liberado antes mesmo de terminar de pagar as suas parcelas, mesmo que nunca ofereça um lance para antecipar a contemplação. E ainda que seja contemplado somente no final, recebe o seu crédito corrigido monetariamente.",
      ],
    },
    {
      title: "03. Posso vender o meu consórcio?",
      cards: [
        {
          title: "Consórcio em andamento",
          body: "Sim, você pode vender e transferir o seu consórcio em andamento (desde que esteja ativo e em dia com os pagamentos) para outra pessoa a qualquer momento, sempre respeitando as regras do contrato e com a prévia autorização da administradora.",
        },
        {
          title: "Consórcio contemplado",
          body: "Caso você seja contemplado e não queira utilizar o crédito, poderá transferir o seu consórcio para outra pessoa e até conseguir uma boa rentabilidade com o ágio. As regras para transferência de cotas estão estabelecidas no contrato e a pessoa que está adquirindo o consórcio deverá passar por uma aprovação de cadastro.",
        },
      ],
    },
  ],
  detail: {
    breadcrumbLabel: "Sobre consórcio",
    heroTagline: "Faça acontecer com a Multiplic Consórcios.",
    anchors: [
      {
        id: "carta-de-credito",
        label: "Liberação do crédito",
      },
      {
        id: "passo-a-passo",
        label: "Quando recebo o crédito?",
      },
      {
        id: "seguranca",
        label: "Segurança",
    ...
    creditCard: {
      ...
      paragraphs: [
        "Quando você for contemplado vai precisar apresentar a documentação do bem que irá adquirir e passar por um processo de avaliação para a liberação de crédito. A aprovação de cadastro e demais garantias necessárias são exigências do Banco Central do Brasil e servem para garantir aos demais participantes do grupo que aquela pessoa que já recebeu o crédito vai continuar pagando as suas parcelas até o final do seu prazo.",
      ],
      cardLabel: "Liberação do crédito",
      cardValue: "Análise e validação",
    },
    steps: {
      title: "02. Quando recebo o crédito?",
      paragraphs: [
        "As contemplações ocorrem nas assembleias mensais, cujo sorteio é realizado pela loteria federal. A retirada do crédito pode ser feita de duas formas: por sorteio, do qual participam todos em iguais condições, e por lance, onde você pode oferecer um percentual de oferta para aumentar suas chances de contemplação.",
        "O lance vencedor pode ser pago com seu próprio recurso financeiro ou utilizando parte do crédito do seu consórcio (conforme características do plano e do regulamento). Após análise de documentações e aprovação, o crédito será liberado.",
        "Atenção: no sistema de consórcio a liberação do crédito ocorre mediante o sorteio pela loteria federal ou através de lances sigilosos — desta forma não há como assegurar um prazo fixo para você ser contemplado e retirar o crédito contratado.",
      ],
      cards: [
        {
          title: "Sorteio",
          body: "Todos participam em iguais condições nas assembleias mensais.",
        },
        {
          title: "Lance",
          body: "Você pode oferecer um percentual de oferta para aumentar suas chances de contemplação.",
        },
        {
          title: "Liberação",
          body: "Após análise de documentações e aprovação, o crédito será liberado.",
        },
      ],
    },
    safety: {
      title: "Fica tranquilo, é seguro como poupança!",
      paragraphs: [
        "Qualquer pessoa que decide investir se preocupa com a segurança da aplicação. A Lei 11.795 do Consórcio garante que o dinheiro é seu. O consórcio é fiscalizado pelo Banco Central do Brasil. Você pode conferir todas as regras no Contrato de Participação.",
        "Você resolve tudo pelo celular.",
      ],
    },
    contact: {
      title: "Somos humanos. Vai um café?",
      paragraphs: [
        "A qualquer momento o time de humanos da Multiplic Consórcios está pronto para atender você. A gente está aqui para te ajudar a fazer sua compra programada, de forma segura.",
      ],
      items: [
...
export default function BeABaPage() {
