...
function Illustration() {
  return (
    <svg aria-hidden="true" className="gd-illustration-icon" fill="none" viewBox="0 0 96 96">
      <path d="M22 70c2-10 10-16 21-16s19 6 21 16" />
      <path d="M48 50a12 12 0 1 0 0-24 12 12 0 0 0 0 24Z" />
      <path d="M68 36a9 9 0 1 0 0-18" />
      <path d="M77 67c-1-6-5-10-10-12" />
    </svg>
  )
}
  ...
  sections: [
    {
      title: "Quem somos?",
      paragraphs: [
        "A Multiplic Consórcios nasceu para transformar uma modalidade tradicional em uma experiência simples, acessível e inovadora, colocando o cliente no centro de tudo.",
        "Oferecemos autonomia para gerir seu planejamento e conquistar casa, carro, moto ou investimentos de forma segura. E, mesmo com uma jornada digital, não abrimos mão da proximidade: nossos especialistas estão sempre prontos para oferecer atendimento personalizado em cada etapa.",
        "Nosso propósito é claro: promover conquistas de um jeito transparente, justo e humano, unindo tecnologia e atendimento de qualidade.",
      ],
    },
    {
      title: "Nossos números contam histórias.",
      paragraphs: [
        "Porque promessas qualquer um faz, mas aqui, a gente trabalha para transformar planejamento em conquista.",
      ],
    },
    {
      title: "Dados cadastrais",
      paragraphs: [
        "A operação está ligada à MULTIPLIC CORRETORA DE SEGUROS LTDA, CNPJ 23.974.875/0001-90, matriz aberta em 08/01/2016.",
      ],
    },
  ],
  detail: {
    breadcrumbLabel: "Quem somos",
    heroTagline: "Somos investidores, como você.",
    anchors: [
      {
        id: "passo-a-passo",
      ...
      {
        id: "seguranca",
        label: "Segurança e contato",
      },
    ],
    steps: {
      title: "Buscar o ideal está no nosso DNA",
      paragraphs: [
        "Nossa missão, visão e valores são nosso compromisso de ser como todo consórcio deveria ser.",
      ],
      cards: [
        {
          title: "Visão",
          body: "Queremos ajudar brasileiros a realizar a compra da casa própria, do carro e de outros objetivos planejados.",
        },
        {
          title: "Missão",
          body: "Democratizar e simplificar a compra de bens e serviços de forma parcelada com uma solução financeira mais acessível.",
        },
        {
          title: "Nossos valores",
          body: "Na Multiplic Consórcios valorizamos: Confiança, ética, excelência, foco no cliente, inclusão, inovação, integridade, parceria, respeito e responsabilidade.",
        },
      ],
    },
    advantages: {
      title: "Somos mais do que um consórcio. Somos o ideal para a sua conquista.",
      paragraphs: [
        "Do pessoal ao empresarial, conte com a Multiplic Consórcios.",
      ],
      cards: [
        {
          title: "Somos solução...",
          body: "Para quem sonha em adquirir uma casa ou carro e procura por uma solução financeira sem apertos.",
        },
        {
          title: "Somos investimento...",
          body: "Para ampliar seu patrimônio financeiro e para planejar seu futuro com tranquilidade.",
        },
        {
          title: "Somos escalabilidade...",
          body: "Para ajudar no crescimento da sua empresa.",
        },
      ],
    },
    safety: {
      title: "Nosso compromisso é proteger seus sonhos",
      paragraphs: [
        "Na Multiplic Consórcios, confiança e segurança são prioridades. Atuamos com governança sólida, cuidado e respeito à privacidade dos seus dados e tecnologia para garantir segurança em cada etapa da sua jornada.",
      ],
      items: [
        "Administrado e regulado pelo Banco Central",
        "Tratamento de dados conforme a Lei Geral de Proteção de Dados Pessoais (LGPD)",
        "Time especializado para orientar do começo ao fim",
      ],
      ctaLabel: "Proteja-se de golpes",
      href: "/guias/seguranca-na-compra",
    },
    contact: {
      title: "Fale com um especialista",
      items: [
        "WhatsApp: (85) 99861-4541",
        "Simule aqui mesmo no site ou fale com um dos especialistas da Multiplic Consórcios.",
      ],
    },
    crossSell: true,
  },
