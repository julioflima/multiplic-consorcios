...
function Illustration() {
  return (
    <svg aria-hidden="true" className="gd-illustration-icon" fill="none" viewBox="0 0 96 96">
      <path d="m48 16 24 9v18c0 17-10 30-24 37C34 73 24 60 24 43V25l24-9Z" />
      <path d="m39 46 6 6 12-14" />
    </svg>
  )
}
...
const page: GuidePage = {
  slug: "seguranca-na-compra",
  title: "Segurança na compra",
  eyebrow: "Ajuda",
  description: "Na Multiplic Consórcios, confiança e segurança são prioridades.",
  sections: [],
  detail: {
    breadcrumbLabel: "Segurança na compra",
    heroTagline: "Na Multiplic Consórcios, confiança e segurança são prioridades.",
    anchors: [
      {
        id: "checklist",
        label: "Segurança",
    ...
    checklist: {
      ...
      items: [
        ...
        "Experiência sólida em atendimento consultivo",
